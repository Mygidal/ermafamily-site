  ...
  return (
    <div className="pt-[80px] px-4 max-w-[1280px] mx-auto text-gray-800 font-inter space-y-8">
      ...
      <section className="text-center max-w-3xl mx-auto space-y-4 text-gray-700">
        ...
        <p>
          Началото ѝ е поставено през <strong>1994 година</strong> от <strong>Цветанка Стоилова Йовева</strong> – основател, визионер, майка. Вдъхновена от баща си, <strong>Стоил Трендафилов</strong>, тя създава „ЕРМА – Цветанка Стоилова“ ЕТ, вплитайки в нея духа на няколко поколения занаятчии.
        </p>
      </section>
      ...
      <section className="text-gray-800 space-y-4">
        ...
        <p>
          В същата традиция е и † <strong>Александър Александров</strong> – отдаден бригадир по груби строежи, ръководил с опит и воля.
        </p>
        <p>
          Днес техните синове – <strong>Боян Георгиев Йовев</strong> (инвеститор и партньор чрез "ХИКС 5 ГРУП ЕООД" „Х5М ГРУП ООД“) и <strong>Андрей Александров</strong> (ръководител на груби строежи в ЕРМА) – продължават тяхното дело.
        </p>
      </section>
      ...
      <section className="mt-12 text-center text-sm text-gray-500 italic space-y-4">
        ...
        <p>
          В памет на <strong>Александър Александров</strong> – доайен на грубия строеж, баща и пример за труд, сила и вярност към занаята.
        </p>
      </section>
    </div>
  );
