export default function PrivacyPage() {
  return (
    <div className="font-inter mx-auto max-w-[800px] space-y-6 px-4 pb-10 pt-[100px] text-gray-800">
      ...
      <p>
        <strong>Последна актуализация:</strong> [въведи дата]
      </p>

      <p>
        <strong>ЕРМА – ФАМИЛНА ООД</strong> се ангажира да защитава личната
        информация на своите клиенти, партньори и посетители на уебсайта.
      </p>
      ...
      <ul className="list-disc space-y-1 pl-5">
        ...
        <li>
          Данни, свързани с използването на сайта чрез „бисквитки“ (cookies)
        </li>
      </ul>
      ...
      <p>
        Ние не продаваме, не разпространяваме и не предоставяме лична информация
        на трети страни, освен ако това не се изисква по закон или за изпълнение
        на наши договорни задължения с Ваше съгласие.
      </p>
      ...
      <p>
        Нашият сайт използва „бисквитки“, за да анализира трафика и да подобри
        функционалността. Имате право да ги изключите чрез настройките на
        браузъра си.
      </p>
      ...
      <p>
        Прилагаме административни, технически и физически мерки за защита на
        Вашата информация от неоторизиран достъп.
      </p>

      <h2 className="text-xl font-semibold text-blue-800">7. Контакти</h2>
      <p>Ако имате въпроси относно поверителността, моля, свържете се с нас:</p>
      <ul className="pl-5">
        <li>
